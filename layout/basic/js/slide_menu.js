...
$(document).ready(function(){
    ...
    // 닫기 버튼을 눌렸을때 닫기버튼 사라져라
    // 슬라이드 사라져라
    // html은 다시 제자리로 와라
    // dimmed사라졌다 나타났다 경우에따라 반복해라
    ...
    $('#aside .categoryList > li > a.cate').click(function(){
        $('.slideSubMenu > li > ul').css({'display':'none'})
    });
